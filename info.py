...
# FORCE_SUB 
auth_req_channel = environ.get('AUTH_REQ_CHANNEL', '-1003993467466')  # requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'identical-eva-vibro1-bd7bf5fd.koyeb.app'))
